...
class DefaultPreflightCostEstimator implements PreflightCostEstimator {
    ...
    DefaultPreflightCostEstimator(PricingRegistry pricingRegistry) {
        this.pricingRegistry = Objects.requireNonNull(pricingRegistry, "pricingRegistry must not be null");
    }
    ...
    public PreflightCostResult estimate(
        ...
        PricingSnapshot snapshot = resolvedSnapshot.orElseThrow();
